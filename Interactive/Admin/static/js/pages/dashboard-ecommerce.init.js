...
linechartcustomerColors &&
  ((options = {
    ...
    plotOptions: { bar: { columnWidth: "50%", barHeight: "70%" } },
...
const Negative = document.getElementById("Negative").innerText;
const Neutral = document.getElementById("Neutral").innerText;
const Positive = document.getElementById("Positive").innerText;
var options,
  chart,
